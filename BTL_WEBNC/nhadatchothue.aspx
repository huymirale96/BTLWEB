<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="Site.master" CodeBehind="nhadatchothue.aspx.cs" Inherits="BTL_WEBNC.nhadatchothue" %>

<asp:Content ID="nhadatchothue" ContentPlaceHolderID="MainContent" runat="server">
				...
				<div class="col-xs-12 col-md-8 col-lg-9 col-md-push-4 col-lg-push-3">
					<div class="list-group result-list">
						...
						<div class="list-group-item Product-TopListing">
							<asp:ListView ID="ListViewthue" runat="server">
								<ItemTemplate>
									<div class="row">
